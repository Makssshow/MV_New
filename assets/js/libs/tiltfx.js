    ...
    (function (window) {
      ...
      TiltFx.prototype._setMouseMoveWatcher = function (self) {
        ...
        if (self.options.element && self.options.element.mouseMoveWatcher) {
          var mouseMoveWatcherElement = document.querySelector(
            self.options.element.mouseMoveWatcher
          );
      ...
      TiltFx.prototype._setViewWatcher = function (self) {
        ...
        if (self.options.element && self.options.element.viewWatcher) {
          var customElementRelative = document.querySelector(
            self.options.element.viewWatcher
          );
          ...
          requestAnimationFrame(function () {
            ...
            for (var i = 0, len = self.imgElems.length; i < len; ++i) {
              var el = self.imgElems[i],
                rotX = moveOpts.rotateX
                  ? ((2 * (((i + 1) * moveOpts.rotateX) / self.imgCount)) /
                      self.view.height) *
                      relmousepos.y -
                    ((i + 1) * moveOpts.rotateX) / self.imgCount
                  : 0,
                rotY = moveOpts.rotateY
                  ? ((2 * (((i + 1) * moveOpts.rotateY) / self.imgCount)) /
                      self.view.width) *
                      relmousepos.x -
                    ((i + 1) * moveOpts.rotateY) / self.imgCount
                  : 0,
                rotZ = moveOpts.rotateZ
                  ? ((2 * (((i + 1) * moveOpts.rotateZ) / self.imgCount)) /
                      self.view.width) *
                      relmousepos.x -
                    ((i + 1) * moveOpts.rotateZ) / self.imgCount
                  : 0,
                transX = moveOpts.translateX
                  ? ((2 * (((i + 1) * moveOpts.translateX) / self.imgCount)) /
                      self.view.width) *
                      relmousepos.x -
                    ((i + 1) * moveOpts.translateX) / self.imgCount
                  : 0,
                transY = moveOpts.translateY
                  ? ((2 * (((i + 1) * moveOpts.translateY) / self.imgCount)) /
                      self.view.height) *
                      relmousepos.y -
                    ((i + 1) * moveOpts.translateY) / self.imgCount
                  : 0,
                transZ = moveOpts.translateZ
                  ? ((2 * (((i + 1) * moveOpts.translateZ) / self.imgCount)) /
                      self.view.height) *
                      relmousepos.y -
                    ((i + 1) * moveOpts.translateZ) / self.imgCount
                  : 0,
            ...
            setTimeout(function () {
              for (var i = 0, len = self.imgElems.length; i < len; ++i) {
                ...
                el.style.WebkitTransform =
                  "perspective(" +
                  moveOpts.perspective +
                  "px) translate3d(0,0,0) rotate3d(1,1,1,0deg)";
                el.style.transform =
                  "perspective(" +
                  moveOpts.perspective +
                  "px) translate3d(0,0,0) rotate3d(1,1,1,0deg)";
      ...
      TiltFx.prototype.init = function () {
        ...
        [].slice
          .call(document.querySelectorAll("img.tilt-effect"))
